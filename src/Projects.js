        ...
        <div className="Projects">
            <section>
                ...
                <div className="container">
                    ...
                    <button><a href="https://agitated-pasteur-f0e70a.netlify.app/" target="_blank">Open Project</a></button>
                    <div className="row">
                        <div className="col-md-6">
                    ...
                    <button><a href="https://thirsty-knuth-10e23b.netlify.app/" target="_blank">Open Project</a></button>
                    <div className="row">
                        <div className="col-md-6">
                    ...
                    <button><a href="https://awesome-hopper-f9a643.netlify.app/" target="_blank">Open Project</a></button>
                    <div className="row">
                        <div className="col-md-6">
